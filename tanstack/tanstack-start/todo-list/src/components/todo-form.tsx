...
const addTodo  = createServerFn({method:"POST"}).inputValidator(
...
const updateTodo  = createServerFn({method:"POST"}).inputValidator(
...
export default function TodoForm({todo}: {todo?: {
  name: string;
  id: string;
} }) {
